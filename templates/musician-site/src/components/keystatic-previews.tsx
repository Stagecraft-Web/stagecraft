...
// ---------------------------------------------------------------------------
// Contact form — stock mockup of the fixed (Name / Email / Subject / Message)
// form rendered by src/components/ContactForm.astro. The block has no schema
// fields, so this preview is purely visual.
// ---------------------------------------------------------------------------
