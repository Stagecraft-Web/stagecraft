...
/**
 * Keystatic admin preview for `responsive-embed`. Mirrors EmbedPreview but
  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
        <span style={labelStyle}>Responsive Embed</span>
