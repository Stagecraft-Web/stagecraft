...
import { ResponsiveEmbedPreview } from "./preview";

/**
 * Markdoc tag `responsive-embed`.
 *
...
export const markdoc: MarkdocTagDefinition = {
  render: "./src/content-components/ResponsiveEmbed/ResponsiveEmbed.astro",
  selfClosing: true,
  attributes: {
...
export const keystatic: KeystaticContentComponent = block({
  ...
  ContentView: ResponsiveEmbedPreview,
});

export const tagName = "responsive-embed";
